...
class ClearanceModule extends CWebModule
{
	public $db;
	private $_assetsUrl;
	private $_clearancePriviledges;
	
	public function isClearanceAdmin()
	{
		$prev = Yii::app()->getModule('user')->getRoles();
		return $prev['System Admin'];
	}
	...
	public function getAssetsUrl()
	{
		if($this->_assetsUrl===null)
			$this->_assetsUrl=Yii::app()->getAssetManager()->publish(
				Yii::getPathOfAlias('clearance.assets') );
