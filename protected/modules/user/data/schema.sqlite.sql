...
INSERT INTO users (id, username, password, email, activkey, superuser, status) VALUES (1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'webmaster@example.com', '21232f297a57a5a743894a0e4a801fc3', 1, 1);
INSERT INTO users (id, username, password, email, activkey, superuser, status) VALUES (2, 'demo', 'fe01ce2a7fbac8fafaed7c982a04e229', 'demo@example.com', 'fe01ce2a7fbac8fafaed7c982a04e229', 0, 1);

INSERT INTO profiles (user_id, lastname, firstname) VALUES (1, 'Admin', 'Administrator');
INSERT INTO profiles (user_id, lastname, firstname) VALUES (2, 'Demo', 'Demo');
